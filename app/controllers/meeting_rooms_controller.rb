class MeetingRoomsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @meeting_room.save
        ...
        format.json { render action: 'show', status: :created, location: @meeting_room }
      else
  ...
  private
    ...
    def meeting_room_params
      params.require(:meeting_room).permit(:room_name, :attendees, :booking_from, :booking_to, :user_id)
    end
end
